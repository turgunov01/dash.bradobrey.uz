globalThis.__timing__.logStart('Load chunks/routes/api/promo-code/_...slug_');import { d as defineEventHandler, p as proxyBackend } from '../../../_/nitro.mjs';
...
const ____slug_ = defineEventHandler(async (event) => {
  ...
  return proxyBackend(event, `/api/promo-code/${slug}`, "none");
});

export { ____slug_ as default };;globalThis.__timing__.logEnd('Load chunks/routes/api/promo-code/_...slug_');
