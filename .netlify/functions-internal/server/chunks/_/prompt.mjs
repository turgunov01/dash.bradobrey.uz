globalThis.__timing__.logStart('Load chunks/_/prompt');import g, { stdin, stdout } from 'node:process';
...
export { kCancel, prompt };;globalThis.__timing__.logEnd('Load chunks/_/prompt');
